<template>
  <div class="app-container">
    ...
    <div ref="filter-container" class="filter-container">
      <el-input v-model="listQuery.agentName" placeholder="Agent Name" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter"/>
      <el-input v-model="listQuery.agentCode" placeholder="Agent Code" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter"/>
